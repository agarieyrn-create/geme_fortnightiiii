...
export type HudSnapshot = { hp: number; maxHp: number; shield: number; ammo: number; reserve: number; remaining: number; elims: number; zone: string; motion: MotionState; aiming: boolean; crouching: boolean; pickup: string; objective?: string; bossName?: string; bossHp?: number; bossMaxHp?: number; weaponName?: string; slots?: Array<WeaponId | null>; medkits?: number };

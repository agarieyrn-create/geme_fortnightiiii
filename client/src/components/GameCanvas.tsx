...
// Stormfall Visual Frame — storm teal, warm sandstone, edge-anchored tactical instrumentation, an angular horizon wordmark, and child-friendly tactical choices.
        ...
        <section className="launch-screen hub-screen" style={{ backgroundImage: `linear-gradient(90deg, rgba(3,10,22,.97) 3%, rgba(3,10,22,.76) 43%, rgba(3,10,22,.22) 100%), url(${REFERENCE_URL})` }}>
          ...
          <div className="hub-card">
            ...
            {hubView === "home" && <>
              ...
              <div className="hub-menu"><button type="button" onClick={() => setHubView("dungeons")}>降下作戦</button><button type="button" onClick={() => setHubView("upgrade")}>戦力強化</button><button type="button" onClick={() => setHubView("loadout")}>装備確認</button><button type="button" onClick={() => setHubView("settings")}>端末設定</button></div>
            </>}
